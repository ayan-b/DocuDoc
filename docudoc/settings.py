"""
Django settings for docudoc project.
...
from docudoc.ckeditor_config import CKEDITOR_CONFIGS
...
WSGI_APPLICATION = 'docudoc.wsgi.application'
...
if IS_PROD:
    ...
    AWS_STORAGE_BUCKET_NAME = 'docudoc'
